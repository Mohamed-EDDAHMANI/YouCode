            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="flex gap-5">
                    <div>
                        <!-- Prénom -->
                        <div>
                            <label for="name" class="block font-medium text-gray-700">Prénom</label>
                            <input id="name" class="block mt-1 w-full border border-gray-300 rounded-lg p-2" 
                        ...
                        <div class="mt-4">
                            ...
                            <input id="password_confirmation" class="block mt-1 w-full border border-gray-300 rounded-lg p-2" 
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input id="lastName" class="block mt-1 w-full border border-gray-300 rounded-lg p-2" 
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-2">
                        <label for="cin" class="block text-center cursor-pointer bg-gray-100 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg shadow-sm hover:bg-gray-200 transition">
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <button type="submit" class="ml-4 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
                        S'inscrire
                    </button>
                </div>
            </form>
