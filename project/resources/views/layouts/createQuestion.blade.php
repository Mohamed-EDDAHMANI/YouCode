            ...
            <form action="{{ route('storeQuastion') }}" method="POST" id="questionForm">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        id="question" name="questionDesignation" rows="2" placeholder="Entrez votre question ici..."
                        required></textarea>
                </div>
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="flex items-center">
                                <input type="radio" id="multipleChoice" name="type" value="choices" 
                                       class="w-4 h-4 cursor-pointer" onchange="toggleQuestionType()" checked>
                ...
                <div id="trueFalseOptions" class="space-y-3 hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition duration-150 response-container-tf"
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="responseTrue" name="is_correct" value="{{ 0 }}"
                                    class="w-5 h-5 cursor-pointer">
                                <span
                                    class="inline-flex items-center justify-center w-6 h-6 ml-2 bg-green-600 text-white rounded-full text-xs">V</span>
                                <input for="responseTrue" class="ml-2 text-gray-700 font-medium" name="designations[]" value="Vrai" readonly/>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg hover:bg-gray-100 transition duration-150 response-container-tf"
                            ...
                            <div class="flex items-center">
                                <input type="radio" id="responseFalse" name="is_correct" value="{{ 1 }}"
                                    class="w-5 h-5 cursor-pointer">
                                <span
                                    class="inline-flex items-center justify-center w-6 h-6 ml-2 bg-red-600 text-white rounded-full text-xs">F</span>
                                <input for="responseFalse" class="ml-2 text-gray-700 font-medium" name="designations[]" value="Faux" readonly/>
                            </div>
                        </div>
                    </div>
                </div>
